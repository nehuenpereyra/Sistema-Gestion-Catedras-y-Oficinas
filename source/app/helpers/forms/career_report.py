...
from app.models import Charge, Workplace, Employee, Career
...
class CareerReport(TranslateForm):

    careers = SelectMultipleField("Carreras", validators=[
    ...
    def __init__(self, *args, **kwargs):
        super(CareerReport, self).__init__(*args, **kwargs)
